...
# Добавляем запись "models/" в .gitignore, если её там ещё нет
if (!file.exists(".gitignore")) {
  writeLines("models/", ".gitignore") # Создаем .gitignore, если его нет
} else {
  gitignore_content <- readLines(".gitignore")
  if (!"models/" %in% gitignore_content) {
    writeLines(c(gitignore_content, "models/"), ".gitignore") # Добавляем запись
  }
}
